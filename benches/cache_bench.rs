...
use rand::{Rng, rng};
use sharded_cachemap::{DHShardedCacheMap, DoubleHashPolicy, EvictionPolicy};
...
async fn bench_cache(
    ...
    let scm = Arc::new(ShardedCacheMap::new(shards, Some(slots), evict_policy));
